...
android {
    namespace = "com.akshayashokcode.audiorecorder"
    compileSdk = 36
...
mavenPublishing {
    ...
    coordinates(
        ...
        artifactId = "audiorecorder",
        version = project.findProperty("VERSION_NAME") as String
    )
    pom {
        name.set("MediaKit AudioRecorder")
        description.set("In-app audio recording for Android with waveform visualisation and timer. Fluent builder API built on Activity Result APIs.")
        ...
        developers {
            developer {
                id.set("AkshayAshokCode"); name.set("Akshay Ashok")
                email.set("akshayashokan1054@gmail.com"); url.set("https://github.com/AkshayAshokCode")
            }
        }
        scm {
            url.set("https://github.com/AkshayAshokCode/MediaKit-android")
