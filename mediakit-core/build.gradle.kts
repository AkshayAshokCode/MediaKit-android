...
android {
    namespace = "com.akshayashokcode.mediakitcore"
    compileSdk = 36
...
mavenPublishing {
    ...
    pom {
        name.set("MediaKit Core")
        description.set("Shared infrastructure for MediaKit-Android modules: PermissionLauncher, TempFileManager, AppAvailabilityUtils, and MediaKitException base class.")
